...
function addProduto($conn, $nome_produto, $quantidade_min, $quantidade_atual) {
    $sql = "INSERT INTO produto (nome_produto, quantidade_min, quantidade_atual, ) VALUES (:nome_produto, :quantidade_min, :quantidade_atual, )";
    $stmt = $conn->prepare($sql);
...
function updateProduto($conn, $id, $nome_produto, $quantidade_min, $quantidade_atual) {
    $sql = "UPDATE produto SET id = :id, nome_produto = :nome_produto, quantidade_min = :quantidade_min, quantidade_atual = :quantidade_atual WHERE id = :id";
    $stmt = $conn->prepare($sql);
